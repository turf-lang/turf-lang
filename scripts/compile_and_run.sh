...
cleanup() {
    ...
    echo -e "${GREEN}[3 / ${TOTAL_STEPS}]${RESET} ${BOLD}Cleaning up temporary files...${RESET}"
    rm -f program
...
"$COMPILER_PATH" "$INPUT_FILE" -o program

echo -e "${GREEN}[2 / ${TOTAL_STEPS}]${RESET} ${BOLD}Running program output:${RESET}"
echo ""
