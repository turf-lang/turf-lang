...
clang++ src/main.cpp src/Lexer.cpp src/Parser.cpp src/Codegen.cpp src/Builtins.cpp src/Algorithms.cpp src/SymbolTable.cpp -Iinclude `llvm-config --cxxflags --ldflags --system-libs --libs core native` -o turf
